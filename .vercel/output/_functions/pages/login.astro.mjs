...
Password
</label> <input class="w-full content-center text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-green-400" type="password" name="password" placeholder="Enter your password"> </div> <div class="flex items-center justify-between"> <div class="flex items-center"> <input id="remember_me" name="remember_me" type="checkbox" class="h-4 w-4 bg-blue-500 focus:ring-blue-400 border-gray-300 rounded"${addAttribute(rememberMe, "checked")}> <label for="remember_me" class="ml-2 block text-sm text-gray-800">
Recuerdame
</label> </div> <div class="text-sm"> <a href="#" class="text-green-400 hover:text-green-500">
¿Olvidaste tu contraseña?
</a> </div> </div> <div> <button id="btn-submit" type="submit" class="disabled:opacity-50 disabled:cursor-not-allowed w-full flex justify-center bg-green-400 hover:bg-green-500 text-gray-100 p-3 rounded-full tracking-wide font-semibold shadow-lg cursor-pointer transition ease-in duration-500">
Iniciar sesión
</button> </div> <div class="w-full flex flex-1"> <div class="w-full my-2 border-t border-gray-300"></div> </div> <button id="btn-google" type="button" class="disabled:opacity-50 disabled:cursor-not-allowed w-full flex justify-center bg-red-500 hover:bg-red-600 text-gray-100 p-3 rounded-full tracking-wide font-semibold shadow-lg cursor-pointer transition ease-in duration-500">
