...
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_78qAxlt4vutxzASYCJ86lQgTyDPNZOgCSCLx6sJsuD", Path: process.env.Path, PUBLIC: process.env.PUBLIC })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.16.13"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.16.13",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_78qAxlt4vutxzASYCJ86lQgTyDPNZOgCSCLx6sJsuD", Path: process.env.Path, PUBLIC: process.env.PUBLIC }).MODE
  },
  telemetry: {
